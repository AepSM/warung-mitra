                        ...
                        <div class="box">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{ $errors->first('keterangan') ? "is-invalid" : "" }}" name="keterangan">
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{ $errors->first('link') ? "is-invalid" : "" }}" name="link">
                                    <div class="invalid-feedback">
